  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute top-[-120px] right-[-140px] h-[460px] w-[460px] rounded-full bg-red-600/14 blur-3xl" />
        <div className="absolute bottom-[-140px] left-[-120px] h-[460px] w-[460px] rounded-full bg-yellow-500/8 blur-3xl" />
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
            <div className="text-center lg:text-right">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 mb-6 backdrop-blur-sm shadow-lg">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-[1.04] tracking-tight mb-6">
                تجربة أذكى
                <br />
                لأعطال السيارات
                <br />
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[2rem] border border-white/10 bg-zinc-950/90 p-6 md:p-7 shadow-2xl backdrop-blur-sm overflow-hidden">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {features.map((feature) => {
                ...
                return (
                  <div
                    key={feature.title}
                    className="rounded-3xl border border-white/10 bg-black/70 p-6 shadow-xl"
                  >
            ...
            {services.map((service) => {
              ...
              return (
                <Link
                  ...
                  className="group rounded-[1.75rem] border border-white/10 bg-zinc-950/90 p-6 text-center shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-red-500/40 hover:bg-zinc-900"
                >
